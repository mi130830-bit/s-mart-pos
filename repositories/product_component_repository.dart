...
class ProductComponentRepository {
  ...
  Future<void> updateComponents(
    ...
    // ✅ 3. Recalculate stock for the parent immediately
    // This fixes the issue where linked products show "Out of Stock" because of stale values.
    try {
      await StockRepository().recalculateParentStock(parentId);
    } catch (e) {
      // Log error but don't block component update
      debugPrint('Error recalculating stock for parent $parentId: $e');
    }
  }
}
