...
*   [x] `lib/screens/reports/delivery_report_screen.dart` (~806 lines) — ✅ Done (Sub-widgets extracted)
*   [x] `lib/screens/settings/backup_settings_screen.dart` (~763 lines) — ✅ Done (Extracted to tabs)
...
*   [x] `lib/screens/products/stock_return_section.dart` (~697 lines) — ✅ Done (Create page & history split)
...
*   [x] `lib/screens/pos/pos_payment_panel.dart` (~639 lines) — ✅ Done (Extracted to widgets)
*   [x] `lib/screens/products/stock_adjustment_section.dart` (~631 lines) — ✅ Done (Sub-widgets split)
*   [x] `lib/screens/products/dialogs/product_form/layouts/product_form_left_column.dart` (~615 lines) — ✅ Done (Part file UI structure)
*   [x] `lib/screens/products/product_import_screen.dart` (~604 lines)
*   [x] `lib/screens/settings/barcode_designer_screen.dart` (~601 lines)
*   [x] `lib/screens/pos/payment_modal/controllers/payment_modal_controller.dart` (~590 lines) — ✅ Done (Mixin & Slip verify controller split)
...
*   [x] `lib/screens/dashboard/dashboard_screen.dart` (~576 lines) — ✅ Done (Tab views split)
*   [x] `lib/screens/pos/pos_checkout_screen.dart` (~575 lines) — ✅ Done (Mixin and dialogs split)
...
*   [x] `lib/screens/customer_display/customer_display_screen.dart` (~527 lines) — ✅ Done (Widgets split)
*   [x] `lib/screens/pos/pos_cart_list.dart` (~527 lines) — ✅ Done (Tile & Constants split)
...
*   [x] `lib/services/firestore_rest_service.dart` (~623 lines) — ✅ Done (REST client & parts split)
