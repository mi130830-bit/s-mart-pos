...
class FinancialReportScreen extends StatefulWidget {
  ...
  const FinancialReportScreen({super.key, this.isEmbedded = false});
...
class _FinancialReportScreenState extends State<FinancialReportScreen> {
  ...
  double get _netProfit => _totalSales - _totalCost; // กำไรคิดจากยอดที่ขายสินค้าวันนั้น - ต้นทนของสินค้าวันนั้นพอ
  double get _cashProfit => _totalSales - _totalPurchases; // เงินสดคงเหลือ: ยอดขาย - ยอดสั่งซื้อ
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: _netProfit >= 0 ? Colors.teal.shade50 : Colors.red.shade50,
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(color: _netProfit >= 0 ? Colors.teal.shade200 : Colors.red.shade200),
                          ),
                          child: Column(
                            children: [
                      ...
                      Expanded(
                        child: Container(
                          padding: const EdgeInsets.all(24),
                          decoration: BoxDecoration(
                            color: _cashProfit >= 0 ? Colors.blue.shade50 : Colors.orange.shade50,
                            borderRadius: BorderRadius.circular(16),
                            border: Border.all(color: _cashProfit >= 0 ? Colors.blue.shade200 : Colors.orange.shade200),
                          ),
                          child: Column(
                            children: [
    ...
    return BarChart(
      BarChartData(
        ...
        barGroups: _chartData.asMap().entries.map((e) {
          ...
          final cost =
              double.tryParse(e.value['totalCost'].toString()) ?? 0.0;
