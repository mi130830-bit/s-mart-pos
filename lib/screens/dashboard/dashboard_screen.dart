...
import '../../services/settings_service.dart'; // ✅ For requireAdminForVoid

import '../../repositories/customer_repository.dart';
import '../../widgets/common/thai_aware_search_field.dart'; // ✅ Added for search
...
class _DashboardScreenState extends State<DashboardScreen>
  ...
  Future<void> _performSearch(String val) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        AlertService.show(
          context: context,
          message: 'เกิดข้อผิดพลาดขณะค้นหาบิล: $e',
          type: 'error',
        );
      }
    }
  ...
  Future<void> _confirmDeleteOrder(Map<String, dynamic> orderRow) async {
    ...
    if (confirm == true) {
      ...
      // ✅ Security: ถ้าเปิด Toggle "บังคับรหัส Admin เมื่อลบบิล" ต้องใส่ PIN ก่อน
                ...
                children: [
                  Expanded(
                    child: ThaiAwareSearchField(
                      ...
                      label: 'ค้นหาเลขที่บิล, ชื่อลูกค้า หรือเบอร์โทรศัพท์ (พิมพ์แล้วกด Enter หรือคลิกปุ่มค้นหา)',
                      ...
                      onChanged: (val) {
                        if (val.isEmpty) {
                          ...
                          setState(() {}); // Rebuild to show "Clear Query" button if needed
                        }
                      },
                    ),
                  ),
  ...
  Widget _buildRecentOrdersTable(AuthProvider auth, bool showMoney) {
    ...
    final ordersToDisplay = _searchQuery.isNotEmpty ? _searchResults : _recentOrders;
    final titleText = _searchQuery.isNotEmpty
        ? 'ผลการค้นหาบิลสำหรับ: "$_searchQuery"'
        : 'รายการล่าสุดวันนี้';
              ...
              children: [
                ...
                Text(
                  _searchQuery.isNotEmpty
                      ? 'ไม่พบข้อมูลบิลสำหรับคำค้น "$_searchQuery"'
            ...
            child: Row(
              ...
              children: [
                ...
                if (_searchQuery.isNotEmpty)
                  Text(
                    'พบทั้งหมด ${ordersToDisplay.length} รายการ',
                    style: TextStyle(
