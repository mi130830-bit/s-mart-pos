...
import '../../repositories/stock_repository.dart'; // Added for history tabs
import '../../repositories/sales_repository.dart'; // Added for sales history
...
class _ProductFormDialogState extends State<ProductFormDialog> {
  ...
  // History Tab State
  List<Map<String, dynamic>>? _stockInHistory; // null = not yet loaded
  ...
  // ─── ประวัติรับเข้า (Stock-In History) ────────────────────────────────────
