        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              const Text('กดปุ่ม "คำนวณรอบนี้" เพื่อสร้างรายการใหม่',
              ...
              title: Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      HrStatusUtils.formatStatus(
                          req.status, HrItemType.payroll),
                      style: TextStyle(
                          color: statusColor,
                          fontSize: 12,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                          'หัก: ฿${currencyFormat.format(req.totalDeductions)}',
                      ...
                      onPressed: () async {
                        final confirm = await showDialog<bool>(
                          ...
                          builder: (context) => AlertDialog(
                            title: const Text('ยืนยันการลบฉบับร่าง'),
                            content: const Text(
