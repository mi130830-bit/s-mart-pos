...
class _LeaveFormDialogState extends ConsumerState<LeaveFormDialog> {
  ...
  Widget _buildEmployeeDropdown(List<EmployeeProfile> employees) {
    return DropdownButtonFormField<EmployeeProfile>(
  ...
  Widget _buildLeaveFormatDropdown() {
    return DropdownButtonFormField<String>(
      decoration: const InputDecoration(
