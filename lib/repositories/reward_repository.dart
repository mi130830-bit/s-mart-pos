...
class RewardRepository {
  ...
  Future<void> initTable() async {
    ...
    await _dbService.ensureColumn('point_reward', 'reward_type', "VARCHAR(10) DEFAULT 'GIFT'");
    await _dbService.ensureColumn('point_reward', 'discount_value', 'DECIMAL(10,2) DEFAULT 0');
    await _dbService.ensureColumn('point_reward', 'coupon_expiry_days', 'INT DEFAULT 30');
    await _dbService.ensureColumn('reward_redemption', 'reward_type', "VARCHAR(10) DEFAULT 'GIFT'");
