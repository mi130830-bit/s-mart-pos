# GPS Wi-Fi Bench Test / ชุดทดสอบ GPS ผ่าน Wi-Fi

This is a bench test for an ESP32 + NEO-M8N GPS only. It intentionally contains
no A7670E/4G logic and must not be used as production vehicle firmware.

นี่คือชุดทดสอบบนโต๊ะสำหรับ ESP32 + GPS NEO-M8N เท่านั้น ไม่มีโค้ด A7670E/4G
และห้ามใช้แทน firmware รถจริง
